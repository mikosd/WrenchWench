...
public class VinUtils {
    private static final int[] values = { 1, 2, 3, 4, 5, 6, 7, 8, 0, 1,
            2, 3, 4, 5, 0, 7, 0, 9, 2, 3, 4, 5, 6, 7, 8, 9 };
    private static final int[] weights = { 8, 7, 6, 5, 4, 3, 2, 10, 0,
            9, 8, 7, 6, 5, 4, 3, 2 };
     ...
     * @return True if the checksum of the VIN matches, false if not
     */
     ...
     *
     * @param vin Vehicle Identification Number
     * @return a Vehicle Object that is build from the vin
     */
